...
import { IRepo } from '../pages/models/models'
...
export const ReposCard = ({ repo }: { repo: IRepo }) => {
   ...
   return (
      <div className='border py-3 px-5 rounded mb-2
      hover:shadow-md hover:bg--gray-100 transition-all'>
         <a href={repo.html_url} target='_blank'>
            ...
            <p className='text-sm'>
               Forks: <span className='font-bold mr-2' >
                  {repo.forks}
               </span>
            </p>
            <p className='text-sm'>
               Wathers: <span className='font-bold'   >
                  {repo.watchers}
               </span>
            </p>
            ...
            {!isFavourite && <button
               ...
               hover:shadow-md transition-all mr-2 '
